...
( () => {
    ...
    ( () => {
        ...
        function(t) {
            var e, i, a = 0, s = window.document, n = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, o = /^(?:text|application)\/javascript/i, r = /^(?:text|application)\/xml/i, l = "application/json", h = "text/html", d = /^\s*$/;
            function c(e, i, a, n) {
                if (e.global)
                    return function(e, i, a) {
                        var s = t.Event(i);
        ...
        class pe extends de {
            _loadMedia() {
                ...
                this.media_id = {},
                this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : S("YOUTUBE IN URL BUT NOT A VALID VIDEO"),
                this.data.url.match("start=") ? this.media_id.start = V(this.data.url.split("start=")[1]) : this.data.url.match("t=") && (this.media_id.start = V(this.data.url.split("t=")[1])),
            ...
            makeGoogleMapsEmbedURL(t, e) {
                ...
                return function(t) {
                    ...
                    function(t, n) {
                        ...
                        return (o = s(l, o)).key = e,
                        1 == i && (t = "streetview"),
                        r + "/embed/v1/" + t + function(t) {
                            var e = [];
                            for (var i in t)
        ...
        class ge extends de {
            constructor(t, e, i) {
                super(t, e, i),
                this.blockquote = Ut().sanitize(this.data.url)
            }
            _loadMedia() {
        ...
        class ye extends de {
            _loadMedia() {
                var t, e = Math.round(this.options.width) || 1e3, i = this.getLanguage().lang.toLowerCase(), a = this;
                try {
                    ...
                    ct(t, (function(t) {
                        ...
                        e.url ? (a.base_image_url = e.url,
                        a.page_id = e.page_id,
                        !a.data.alt && e.label && (a.data.alt = e.label),
                        a.options.background || a.createMedia(),
                        a.onLoaded()) : a.loadErrorDisplay(a._("wikipedia_image_load_err"))
                    }
                    ))
                } catch (t) {
            ...
            establishMediaID() {
                ...
                if (!t)
                    throw new x("Invalid Wikipedia Image URL");
                this.media_id = t
            }
            createMedia() {
                var t = this;
                if (this._el.content_item = this.domCreate("img", "tl-media-item tl-media-image tl-media-wikipedia-image tl-media-shadow", this._el.content),
                this.data.alt)
                    ...
                    mt(`https://commons.wikimedia.org/w/api.php?action=wbgetentities&format=json&ids=${e}&format=json&origin=*`).then((i => {
                        if (i.entities && i.entities[e]) {
                            ...
                            n ? (console.log(`wikibase_id: ${t.media_id} alt ${n.value}`),
                            t.data.alt = n.value,
                            t._el.content_item.alt = t.data.alt) : console.log(`wikibase_id: ${t.media_id} ain't got no alt`)
                        }
                    }
                    ))
                }
            ...
            _getImageURL(t, e) {
                if (t && this.base_image_url) {
                    ...
                    if (e)
                        ...
                        this.base_image_url.replace(e[1], `/${t}px-`)
                }
        ...
        class ke extends de {
            _loadMedia() {
                ...
                -1 != this.data.url.indexOf("dai.ly/") ? this.media_id = this.data.url.substr(this.data.url.indexOf("dai.ly/") + 7) : this.data.url.match("video") ? this.media_id = this.data.url.split("video/")[1].split(/[?&]/)[0] : this.media_id = this.data.url.split("embed/")[1].split(/[?&]/)[0],
        ...
        class Te extends de {
            _loadMedia() {
                var t, e = this;
                if (this._el.content_item = this.domCreate("div", "tl-media-twitter", this._el.content),
                this._el.content_container.className = "tl-media-content-container tl-media-content-container-text",
            ...
            createMedia(t) {
                ...
                (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).match(/^https?:\/\/(pic\.(twitter|x)\.com)/i) ? (ue("https://platform.twitter.com/widgets.js", (function() {
        ...
        class Me extends de {
            _loadMedia() {
                ...
                l && l.length > 2 ? (this.media_id = l[2],
                t = "https://api.twitter.com/1/statuses/oembed.json?id=" + this.media_id + "&omit_script=true&include_entities=true&callback=?",
                window.twttr = (a = "script",
                s = "twitter-wjs",
                o = (i = document).getElementsByTagName(a)[0],
                r = window.twttr || {},
                i.getElementById(s) || ((n = i.createElement(a)).id = s,
        ...
        class Ee extends de {
            _loadMedia() {
                ...
                try {
                    ...
                    ct(t, (function(t) {
                        "ok" == t.stat ? (e.sizes = t.sizes.size,
                        e.options.background || e.createMedia(),
                        e.onLoaded()) : e.loadErrorDisplay(e._("flickr_notfound_err"))
                    }
                    ))
                } catch (t) {
            ...
            establishMediaID() {
                if (this.data.url.match(/flic.kr\/.+/i)) {
                    ...
                    if (-1 == e)
                        throw new x("flickr_invalidurl_err");
                    var i = e + 18;
        ...
        class Le extends de {
            _loadMedia() {
                ...
                this._el.content_item.id = P(7),
                this.data.url.match(/\.html$/) ? this.data.url = this._transformURL(this.data.url) : this.data.url.match(/.(json|js)$/) || S("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"),
                ue(["https://assets.documentcloud.org/viewer/loader.js", "https://assets.documentcloud.org/viewer/viewer.js"], (function() {
                    t.createMedia()
                }
                ))
            }
        ...
        class Ae extends de {
            ...
            getImageURL() {
                ...
                mt(`${De}${this.data.url}`).then((t => t.thumbnail_url)).catch((t => {
                    S(`Instagram getImageURL Error: ${t.status} ${t.statusText}`)
                }
                ))
            }
            _getMeta() {
                this.oembed_response && this.oembed_response.author_name && (this.data.credit_alternate = `Instagram: <a href="https://instagram.com/${this.oembed_response.author_name}" target="_blank">@${this.oembed_response.author_name}</a>`),
                this.updateMeta()
            }
            sizes(t) {
        ...
        class Ie extends de {
            _loadMedia() {
                ...
                t = this.data.url.match(/open\?id=([^&]+)/) ? "https://drive.google.com/file/d/" + this.data.url.match(/open\?id=([^&]+)/)[1] + "/preview" : this.data.url.match(/file\/d\/([^/]*)\/?/) ? "https://drive.google.com/file/d/" + this.data.url.match(/file\/d\/([^/]*)\/?/)[1] + "/preview" : this.data.url,
        ...
        class Oe extends de {
            _loadMedia() {
                ...
                this.media_id ? (t = "https://embed.spotify.com/?uri=" + this.media_id + "&theme=white&view=coverart",
            ...
            _updateMediaDisplay(t) {
                ...
                e > this.options.width ? (S("height is greater"),
                i = this.options.width + 80 + "px",
                a = this.options.width + "px") : (S("width is greater"),
                S(this.options.width),
                i = e + "px",
                a = e - 80 + "px"),
                    ...
                    success: function(e) {
                        try {
                            ...
                            setInterval((function() {
                                null == document.querySelector("blockquote.imgur-embed-pub") ? clearInterval() : (imgurEmbed.createIframe(),
        ...
        class Pe extends de {
            _loadMedia() {
                ...
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe", this._el.content);
                var e;
                e = o || _ || t.match(/dl.dropboxusercontent.com/) ? "<iframe class='doc' frameborder='0' width='100%' height='100%' src='//docs.google.com/viewer?url=" + t + "&amp;embedded=true'></iframe>" : "<iframe class='doc' frameborder='0' width='100%' height='100%' src='" + t + "'></iframe>",
        ...
        class We {
            ...
            getFormattedDate() {
                if (O(this.data.display_date).length > 0)
                    return this.data.display_date;
                var t = "";
                return this.has.title || (this.data.end_date && (t = " &mdash; " + this.data.end_date.getDisplayDate(this.getLanguage())),
        ...
        async function Je(t, e) {
            return e || (e = "https://sheets-proxy.knightlab.com/proxy/"),
            await te(t, {
                sheets_proxy: e
            })
        }
